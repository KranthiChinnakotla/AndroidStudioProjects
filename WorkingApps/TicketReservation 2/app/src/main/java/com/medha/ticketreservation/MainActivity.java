/*  Assignment #: Group02_HW02
    File Name:  TicketReservation
    Name : Teja Kanchinadam
    Name: Kranthi K Chinnakotla
    Name: Raja Challa
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnCreateTicket,btnDeleteTicket,btnEditTicket,btnViewTicket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnViewTicket = (Button) findViewById(R.id.button_view);
