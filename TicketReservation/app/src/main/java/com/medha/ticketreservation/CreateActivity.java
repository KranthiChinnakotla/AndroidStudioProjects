...
public class CreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.editText_departuretime).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //  destinationText.setText(myString);
        ...
        btnPrintSummary.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((sourceText.getText().toString().equals(destinationText.getText().toString()))&& sourceText.getText().length()!= 0 ){
                    ...
                    ticketDetails = new TicketDetails(pasngrName, sourceText.getText().toString(), destinationText.getText().toString(), departureDateText.getText().toString(), departureTime.getText().toString(), returnDate.getText().toString(), returnTIme.getText().toString());
                    intent = new Intent(CreateActivity.this,PrintActivity.class);
                    intent.putExtra(TICKET_KEY, ticketDetails);
                    startActivity(intent);
                } else if(returnDate.getText().length() == 0) {
                    ticketDetails = new TicketDetails(pasngrName, sourceText.getText().toString(), destinationText.getText().toString(), departureDateText.getText().toString(), departureTime.getText().toString(),null,null);
                    intent = new Intent(CreateActivity.this, PrintActivity.class);
                    intent.putExtra(TICKET_KEY, ticketDetails);
                    startActivity(intent);
                }
    ...
    TimePickerDialog.OnTimeSetListener myTime = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            if(hour >= 12)
            activeEditTextTime.setText(""+hour+":"+minutes + " PM");
            else
                activeEditTextTime.setText(""+hour+":"+minutes + " AM");
