        ...
        protected void onPostExecute(String s) {
            if (s != null) {
                ...
                if (s.equals("Valid")) {
                    ...
                    //dmnotes = new DatabaseDataManager(AddCityActivity.this,"citynotes.db");
                    dmcities = new DatabaseDataManager(AddCityActivity.this,"cities");
                    dmcities.saveCity(new CityDetails(cityName,stateName));
                    dmcities.settingCityId(new CityDetails(cityName,stateName));
